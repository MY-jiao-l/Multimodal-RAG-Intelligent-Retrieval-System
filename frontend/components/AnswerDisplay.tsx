...
const queryTypeLabels: Record<QueryType, { label: string; color: string }> = {
  exact_query: { label: "精确查询", color: "from-blue-500/20 to-cyan-500/20 text-blue-700 border-blue-500/30" },
  filter_query: { label: "过滤查询", color: "from-purple-500/20 to-pink-500/20 text-purple-700 border-purple-500/30" },
  general_query: { label: "通用查询", color: "from-emerald-500/20 to-teal-500/20 text-emerald-700 border-emerald-500/30" },
};
        ...
        <div className="flex items-start gap-3">
          ...
          {onNewQuestion && (
            <Button
              ...
              className="flex-shrink-0 h-8 px-3 text-[12px] border-border/60 text-foreground hover:border-primary/40 hover:bg-primary/10 hover:text-primary"
            >
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-3">
                <h3 className="text-[15px] font-semibold text-foreground/90">AI 回答</h3>
                <Badge
                  variant="default"
